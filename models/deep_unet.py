### The code is taken from the official implementation of the paper "DeepUNet: A Deep Fully Convolutional Network for Pixel-level Sea-Land Segmentation" 
...
class DeepUnet(nn.Module):
    ...
    def forward(self, inputs):
        assert inputs.size()[-2:] == (1280, 1280), ValueError(f"Input shape mismatch. It should be 640x640 while the input shape is {inputs.size()[-2:]}")
